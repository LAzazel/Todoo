...
class TestCommands:
    def test_register_success(self):
        ...
        handler = RegisterUserHandler(repo_mock, factory_mock, hasher_mock, audit_mock)
    ...
    def test_create_todo_success(self):
        ...
        handler = CreateTodoHandler(repo_mock, factory_mock, audit_mock)
    ...
    def test_change_todo_status(self):
        ...
        handler = ChangeTodoStatusHandler(repo_mock, audit_mock)

...
class TestCommands:
    def test_register_success(self):
        ...
        handler = RegisterUserHandler(repo_mock, factory_mock, hasher_mock)
    ...
    def test_create_todo_success(self):
        ...
        handler = CreateTodoHandler(repo_mock, factory_mock)
    ...
    def test_change_todo_status(self):
        ...
        handler = ChangeTodoStatusHandler(repo_mock)
    ...
    def test_change_phone_success(self):
        ...
        handler = ChangePhoneHandler(repo_mock)
    ...
    def test_admin_delete_user_success(self):
        ...
        handler = DeleteUserHandler(repo_mock)

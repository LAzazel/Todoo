...
from app.modules.core.domain.errors import UserNotFoundError, UnauthorizedAdminAccessError
...
from app.modules.core.application.events.user_events import UserDeleted
